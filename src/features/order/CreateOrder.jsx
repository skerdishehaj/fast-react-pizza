...
function CreateOrder() {
  ...
  return (
    <div className="px-4 py-6 ">
      ...
      {/* Only POST, PATCH and DELETE are going to work */}
...
export const action = async ({ request }) => {
  ...
  // Do not overuse this method, it is not a good practice because it deactivates a couple of performance optimizations of Redux on this page
